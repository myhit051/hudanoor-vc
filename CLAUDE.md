...
- หน้าบันทึกยอดขาย:
  - ช่อง "ค่าส่ง" **แสดงตลอด** อยู่ใต้ช่องทาง/สาขา ก่อนส่วนเพิ่มสินค้า (บอสอยากให้อยู่ก่อนบรรทัดส่วนลด และยอดรวมต้องตรงกับสลิปโอน)
  ...
  - ปุ่ม "บันทึกและล้างทั้งหมด" = ล้างทุกอย่าง
...
- หน้าจัดส่ง:
  ...
  - ผู้ส่งบนใบปะหน้ามาจากตั้งค่าร้าน · ออเดอร์ COD มีแถบดำ "COD เก็บเงินปลายทาง ฿…" ตัวใหญ่
